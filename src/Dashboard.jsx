...
? ${naechstesSpiel.mannschaften?.name} vs. $`{naechstesSpiel.gegner}` :${naechstesSpiel.gegner} vs. latex
{naechstesSpiel.mannschaften?.name}`} &lt;/div&gt; &lt;div style={{ fontSize: 13, color: 'rgba(255,255,255,.85)', margin: '3px 0 12px' }}&gt; {naechstesSpiel.datum} {naechstesSpiel.uhrzeit ? `· 

{naechstesSpiel.uhrzeit.slice(0, 5)} Uhr: ''} {naechstesSpiel.halle ? · ${naechstesSpiel.halle} : ''}
</div>
...
? ${a.spiele?.mannschaften?.name} vs. $`{a.spiele?.gegner}` :${a.spiele?.gegner} vs. latex
{a.spiele?.mannschaften?.name}`} &lt;/div&gt; &lt;div style={{ fontSize: 12.5, color: '#5B6D66', margin: '3px 0 8px' }}&gt; {a.spiele?.datum} {a.spiele?.uhrzeit ? `· 

{a.spiele.uhrzeit.slice(0, 5)} Uhr` : ''}
</div>
